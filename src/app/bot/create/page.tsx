                  ...
                  <div className="col-span-6">
                    ...
                    <div className="grid grid-cols-6">
                      <div className="col-span-3 grid grid-cols-12">
                        <div className="col-span-6 w-full flex justify-center py-2 rounded-l-lg font-bold cursor-default bg-background-main text-text-ligth">
                          SIMULADO
                        </div>
                        <div className="col-span-6 w-full flex justify-center py-2 rounded-r-lg font-bold cursor-pointer border border-gray-300 text-text-primary">
                          REAL
                        </div>
                      </div>
                    </div>
