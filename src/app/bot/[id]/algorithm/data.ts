import {
  FunctionsOptionsType,
  ModelDataSelectType,
  ModelFunctionSelectType,
    ...
    functions: [
      {
        ...
        info: {
          description:
            "As médias móveis são ferramentas amplamente utilizadas na análise técnica de mercados financeiros e em outras áreas da estatística e da previsão. Elas ajudam a suavizar os dados, eliminando as flutuações de curto prazo e destacando tendências mais longas.",
          code: {
        ...
        params: [
          {
            ...
            info: {
              description:
                "Aqui você diz a quantidade de velas que você quer buscar a informação",
            },
            input: {
              placeholder: "0.00",
              type: "number",
    ...
    functions: [
      {
        ...
        info: {
          description:
            "Busca em qual posição do fibonacci o valor atual do ativo está",
          code: {
