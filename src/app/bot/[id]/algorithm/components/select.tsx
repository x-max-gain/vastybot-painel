...
export default function CreateBotAlgorithmSelect({
  title,
  options,
  setElementSelect,
  startOpen = false,
}: CreateBotAlgorithmSelectType) {
  ...
  return (
    <div className="select-bot relative">
      <div
        ...
        className="min-w-72 bg-background-secondary text-text-primary px-4 py-2 rounded-md flex items-center cursor-pointer"
      >
        {!open ? (
      ...
      {open && (
        <div className="z-20 select-bot-list bg-background-primary border border-gray-500 w-full rounded-md">
          <ul>
