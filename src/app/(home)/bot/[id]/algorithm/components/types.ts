...
export type LogicContinue = Array<
  DataFunctionType | LogicMainType | ComparisonMainType
>;
...
export type ComparisonContinue = Array<
  DataFunctionType | LogicMainType | ComparisonMainType
>;
...
export const SignalObjectDataValuesType = [
  "percent",
  "number",
  "boolean",
  "float",
